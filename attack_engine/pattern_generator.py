...
class PatternGenerator:
    ...
    def generate(self, pattern_type: Optional[str] = None) -> LaserPattern:
        ...
        Raises:
            ValueError: If pattern_type is unrecognized.
        """
        ...
        if ptype in ("single", "single_spot"):
            ...
            raise ValueError(
                ...
                "Supported types: 'single', 'random', 'horizontal_line', 'vertical_line', 'grid', 'custom'."
            )
